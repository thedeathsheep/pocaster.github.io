---
layout: post
title: 基于 Dify 的企业级工作流 Agent 搭建指南
...
mermaid: true
published: true
excerpt: 用 Dify 搭企业向工作流 Agent：平台能力、设计原则、节点与知识库、API 集成、测试部署、场景示例与运维迭代的一篇长笔记。
---
[Dify](https://dify.ai) 是开源的 LLM 应用开发平台（品牌写作 **Dify**，下文同）。下文记录如何在其上搭建**工作流型**企业 Agent：从准备、节点设计、知识库到集成与上线，偏操作清单与结构图，便于自己复盘。
...
技术之外，仍取决于对业务与组织的理解；低代码降低的是**搭建与试错成本**，不自动等于 ROI。
